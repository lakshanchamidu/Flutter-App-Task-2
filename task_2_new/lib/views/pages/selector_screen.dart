...
class _SelectorPageState extends State<SelectorPage> {
  ...
  Widget build(BuildContext context) {
    return Consumer<MoodListProvider>(
      builder: (context, moodProviderModel, child) => Scaffold(
                        ...
                        children: [
                          ...
                          InkWell(
                            ...
                            child: Container(
                              ...
                              child: Text(textAlign: TextAlign.center, "Save"),
                            ),
                          ),
                        ],
                      ),
                      ...
                      Container(
                        ...
                        decoration: const BoxDecoration(
                          gradient: LinearGradient(
                            colors: [
                              KColors.yellowButton,
                              KColors.gradientPink,
                            ],
                      ...
                      itemBuilder: (context, index) {
                        return Padding(
                          ...
                          child: CustomButton(
                            ...
                            isSelected:
                                moodProviderModel.selectedIndex == index,
                            onPressed: () {
